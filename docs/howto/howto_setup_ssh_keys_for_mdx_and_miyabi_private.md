...
> 1. Local PC -> MDX workflow client (`qii-kawasaki-miyabi-cli.cspp.cc.u-tokyo.ac.jp`)
> 2. MDX workflow client -> Miyabi-C (`miyabi-c.jcahpc.jp`)
>
...
```text
Host mdx
    HostName qii-kawasaki-miyabi-cli.cspp.cc.u-tokyo.ac.jp
    User z12345
